...
export function FlameIcon({ className }: { className?: string }) {
  return (
    <svg viewBox="0 0 24 24" fill="currentColor" className={className}>
      <path d="M12 2C9 6 6 9 6 14c0 4 3 7 6 7s6 -3 6 -7c0 -1.5 -0.4 -2.6 -1 -3.6 0.1 1.7 -0.7 2.9 -1.7 3.3 0.6 -2.4 -0.4 -4.3 -1.8 -5.7 -0.3 1.8 -1 2.8 -2 3.5 0.3 -3 -0.2 -5.6 -1.5 -8.5z" />
    </svg>
  );
}
...
export function LogoMark({ className }: { className?: string }) {
  return (
    <svg viewBox="0 0 24 24" fill="none" className={className}>
      ...
      <path d="M12 7v5l3.2 1.9" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" />
    </svg>
  );
}
